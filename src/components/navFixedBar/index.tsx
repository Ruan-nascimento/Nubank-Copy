...
export const NavFixedBar = () => {
  return(
    <nav className="w-5pc bg-black/80 backdrop-blur-lg backdrop-brightness-50 shadow-white/5 shadow-xl absolute bottom-8 left-2-5pc rounded-full flex justify-between overflow-hidden p-1">
